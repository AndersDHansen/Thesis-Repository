...
from sensitivity_analysis import (run_risk_sensitivity_analysis, run_bias_sensitivity_analysis, 
                                  ...
                                  run_cvar_alpha_sensitivity_analysis)
...
def run_contract_negotiation_sensitivity(input_data: InputData, 
    ...
    # Run capture rate sensitivity analysis with a fresh copy
    ...
    if original_data.contract_type == "Baseload":
    ...
    results = {
        ...
        "capture_rate_sensitivity": capture_rate_sensitivity_results,
...
def save_results_to_csv(results_dict, contract_type,time_horizon, num_scenarios):
    ...
    result_names_not_risk = [
        ...
        "negotiation_power_sensitivity", "negotiation_earnings_sensitivity", # beta results are negotation results
        ]
    ...
    for i, result_name in enumerate(result_names_risk):
        ...
        data = results_dict[result_name]
        if result_name == "boundary_results":
...
def main():      # Define simulation parameters
    ...
    if sensitivity == True:
        ...
        cm_model,results = run_contract_negotiation(
            copy.deepcopy(input_data),
        )
